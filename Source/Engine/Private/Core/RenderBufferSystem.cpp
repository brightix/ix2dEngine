...
void RenderBufferSystem::Tick(double delta_time)
{
...
RenderBufferSystem::RenderBufferSystem() : buffer_type(1) {}

void RenderBufferSystem::CreateWorker(std::function<void()> task)
{
    thread.emplace_back(task);
}

void RenderBufferSystem::PhysicsBuffer(std::vector<Actor*> actors)
{
...
void RenderBufferSystem::Render()
{
